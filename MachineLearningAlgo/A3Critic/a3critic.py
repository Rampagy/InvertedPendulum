...
class A3CAgent:
    def __init__(self, state_size, action_size, env_name):
        ...
        self.hidden1, self.hidden2, self.hidden3 = 24, 24, 24
        self.threads = 8
    ...
    def build_model(self):
        ...
        actor_hidden1 = Dense(self.hidden2, activation='relu', kernel_initializer='glorot_uniform')(shared)
        actor_hidden2 = Dense(self.hidden3, activation='relu', kernel_initializer='glorot_uniform')(actor_hidden1)
        ...
        value_hidden2 = Dense(self.hidden3, activation='relu', kernel_initializer='he_uniform')(value_hidden1)
        state_value = Dense(1, activation='linear', kernel_initializer='he_uniform')(value_hidden2)
    ...
    def train(self):
        ...
        while True:
            ...
            self.save_model('./cartpole_a3c.h5')
